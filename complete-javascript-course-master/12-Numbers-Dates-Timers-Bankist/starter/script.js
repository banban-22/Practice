...
const account1 = {
  ...
  movementsDates: [
    ...
    '2022-08-05T14:11:59.604Z',
    '2022-08-06T17:01:17.194Z',
...
// Base10 - 0 to 9. 1/10 = 0.1. 3/10 = 3.333333
// Binary(Base2) - 0,1
...
console.log(Number.parseInt('e323', 10));
...
console.log(Number.isNaN(Number.parseFloat('20X')));
console.log(typeof Number.parseFloat('20X'));
...
// Rounding decimals (convert to String)
...
console.log(611351365113516513216513134153530511653131341n);
console.log(BigInt(6113513651135));

// Operations
console.log(1000n + 1000n);
console.log(531313651361351365136513651n * 100000000000n);
// console.log(Math.sqrt(16n));

const huge = 2125122542423543541316111651630n;
const num = 23;
...
console.log(new Date('Aug 09 2022 10:59:13'));
...
console.log(future.getDay()); //0 -> Sun
